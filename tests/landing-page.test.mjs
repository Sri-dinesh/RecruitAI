...
function runLandingPageTests() {
  ...
  // Support both root-relative path (frontend/src/app/page.tsx) and frontend-relative path (src/app/page.tsx)
  let targetFile = path.join(projectRoot, 'frontend', 'src', 'app', 'page.tsx');
  if (!fs.existsSync(targetFile)) {
    targetFile = path.join(projectRoot, 'src', 'app', 'page.tsx');
  }
