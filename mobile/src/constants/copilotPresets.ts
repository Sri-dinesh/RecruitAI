    ...
    prompts: [
      {
        ...
        prompt:
          "Rank all candidates in our pool by match score. Detail the top 3 with their key technical competencies and why they stand out.",
      },
      {
        ...
        prompt:
          "Which candidates score above 80%? Summarize their primary differentiators and readiness for immediate interview loops.",
      },
      {
        ...
        prompt:
          "Filter candidates with 5 or more years of experience. List their primary architecture experience and past technical roles.",
      },
      {
        ...
        prompt:
          "Identify any candidates in our talent pool who have zero critical competency gaps for this requisition.",
      },
    ],
  },
  {
    ...
    prompts: [
      {
        ...
        prompt:
          "Compare our top 2 ranked candidates side-by-side. Highlight their technical fit, architecture depth, experience, and leadership tradeoffs.",
      },
      {
        ...
        prompt:
          "Who among our candidates has stronger hands-on system architecture, microservices, and cloud infrastructure experience?",
      },
      {
        ...
        prompt:
          "Evaluate the tradeoff between our most experienced candidate and our most technically aligned stack specialist.",
      },
    ],
  },
  {
    ...
    prompts: [
      {
        ...
        prompt:
          "Generate a 5-question technical screening loop tailored to this exact job specification. Include the expected benchmark answers and what signals to look for.",
      },
      {
        ...
        prompt:
          "Review the identified skill gaps across our top candidates and generate 3 targeted probing questions to test their capability to adapt.",
      },
      {
        ...
        prompt:
          "Generate 3 behavioral interview questions evaluating cross-functional collaboration, conflict resolution, and engineering ownership.",
      },
      {
        ...
        prompt:
          "Formulate a 45-minute system design interview problem that tests candidate proficiency in scalable distributed systems and databases relevant to this position.",
      },
    ],
  },
  {
    ...
    prompts: [
      {
        ...
        prompt:
          "Draft a warm, high-converting interview invitation email for our highest-scoring candidate. Mention their specific matched technical skills and explain why our team is excited to speak.",
      },
      {
        ...
        prompt:
          "Draft a polite status update email for runner-up candidates keeping them engaged for future team openings while highlighting their strong qualifications.",
      },
      {
        ...
        prompt:
          "Draft an interview confirmation email with agenda details, interviewer expectations, and a placeholder for video meeting link.",
      },
    ],
  },
  {
    ...
    prompts: [
      {
        ...
        prompt:
          "Analyze the biggest recurring skill gaps across our entire candidate pool for this position. What critical skills are candidates missing most often?",
      },
      {
        ...
        prompt:
          "Which candidate has the lowest technical gap and will require the shortest ramp-up time to become fully productive in our tech stack?",
      },
      {
        ...
        prompt:
          "Scan our candidate records and highlight any notable red flags, severe experience deficits, or criteria mismatches for this requisition.",
      },
    ],
  },
  {
    ...
    prompts: [
      {
        ...
        prompt:
          "Search the web using Tavily for current market salary benchmarks for this job title and location. Provide typical base pay, equity norms, and total compensation percentiles.",
      },
      {
        ...
        prompt:
          "Search live web job postings for similar roles at top tech companies. What emerging skills and certifications are industry peers currently prioritizing?",
      },
      {
        ...
        prompt:
          "Benchmark our required tech stack against current industry hiring standards for this seniority level. Are our expectations calibrated to attract top tier talent?",
      },
    ],
  },
];
